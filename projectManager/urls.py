...
urlpatterns = [
    ...
    path('<int:project_id>/toggle-participate/', project_views.toggle_participate, name='toggle_participate'),
    path('skills/', project_views.skills_search, name='skills_search'),
    path('<int:project_id>/skills/add/', project_views.skill_add, name='skill_add'),
    path('<int:project_id>/skills/<int:skill_id>/remove/', project_views.skill_remove, name='skill_remove'),
]